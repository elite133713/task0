...
docker-compose -p symfony-test exec percona bash -c "mysql -uroot -proot -e \"IF NOT EXISTS(SELECT * FROM sys.databases WHERE name = 'master') BEGIN create database master CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;\" END"
